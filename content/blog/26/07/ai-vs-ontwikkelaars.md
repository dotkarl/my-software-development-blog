...
Hoe verhouden we ons daartoe? Kijk uit, merkte mijn manager op: een groot deel van haar sollicitanten was aan het solliciteren geslagen precies *omdat* hun huidige werkgever vol op AI had ingezet. De ontwikkelaars voelden zich niet meer thuis in die nieuwe wereld. 


Ze hadden er een hekel aan enkel nog code te [reviewen](/tags/code-reviews/ "Blogs met de tag 'code reviews'"), ze wilden weer terug code met de hand te schrijven.


Hebben die ontwikkelaars het mis? Blijven zij achter?[^1]
...
Er zijn ook ontwikkelaars waarvoor code slechts een middel is. Zij halen hun plezier uit het oplossen van (business)problemen. Code is één manier om een probleem op te lossen. Een stakeholder ervan overtuigen dat diegene zijn proces moet versimpelen of standaardiseren, is een andere.


Zulke ontwikkelaars hoeven AI niet te vrezen. Voor hen is AI een hulpmiddel om het uiteindelijke doel te bereiken. (Is dit dan de groep waarin ik val?)


## De waarde van code


Hier moet ik een belangrijke nuance aanbrengen. Als ik zeg dat code slechts één manier is om een probleem te bereiken -- een middel tot een doel --, dan beweer ik niet dat de code op zichzelf waardeloos is.


Alle code kan (*nu*) een probleem oplossen, ook slechte code. Maar zulke code is desondanks onwenselijk. Want slechte code is een barrière (*straks*) voor het oplossen van het volgende probleem.


Om op een duurzame manier ons werk te kunnen doen, moet de code van hoog niveau zijn. Ze moet onderhoudbaar zijn, uitbreidbaar, maar vooral: ze moet duidelijk communiceren wat (ons huidige begrip van) het probleem is.


Programmeurs formuleerden hun begrip traditioneel in code. Wie zijn begrip van het probleem niet *kan* formuleren, omdat de AI al het denkwerk heeft gedaan, kan zijn werk als ontwikkelaar niet doen. Wie zijn verantwoordelijkheid voor het begrip van een probleem volledig uitbesteedt aan een AI, schildert zichzelf in een hoek. 
