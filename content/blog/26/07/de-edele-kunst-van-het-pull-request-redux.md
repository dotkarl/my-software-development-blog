...
date: 2026-07-17T07:48:34+02:00
draft: false
comments: true
...
De schrijver van code moet uitleggen waarom de code bestaat, wat deze doet en hoe deze dat doet. Dat betekent dat elke codewijziging, vastgelegd in een PR, gepaard moet gaan met een korte uiteenzetting van de bestaansreden van de code en met een set geautomatiseerde tests. Wanneer één van beide aspecten ontbreekt (ik veronderstel dat de daadwerkelijke codewijziging altijd aanwezig is) of ondermaats is, is dit onmiddellijk een reden om het PR tegen te houden. 
...
[^1]: Dat kan betekenen: "een nieuw stuk code" of "een wijziging in een bestaand stuk code". De meeste PR's zullen de laatste categorie betreffen.

[^2]: Een collega van me zei onlangs, niet helemaal als grap, dat zijn ervaring juist omgekeerd was: hij vertrouwde de *contributors* van een OS-project waar hij aan had bijgedragen, juist meer dan zijn huidige collega's! (Zie ook [deze blog](/blog/25/10/borrelpraat-2/ "'Borrelpraat #2'").) Des te meer reden, zou ik zeggen, om samen met die collega's op te trekken in een poging hun niveau op te krikken! 