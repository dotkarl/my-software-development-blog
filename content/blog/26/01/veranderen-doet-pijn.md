...
Ik zie een parallel in de wereld van softwareontwikkeling. We werken binnen onze organisatie met [Scrum](/tags/scrum/ "Blogs met de tag 'Scrum'"). Dat framework verdeelt het werk in (doorgaans) tweewekelijkse [Sprints](https://www.scrum.org/resources/what-is-a-sprint-in-scrum "'What is a Sprint', Scrum.org"). Aan het eind van elke Sprint toon je het resultaat van je inspanningen. Maar wat je vaak bij ons ziet gebeuren, is dat mensen zeggen: maar dit is nog niet af, laten we het tonen van deze feature verplaatsen naar de volgende Sprint.
