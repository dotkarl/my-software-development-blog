...
date: 2026-06-26T07:05:31+02:00
draft: false
comments: true
...
Laat ik hiermee beginnen: [een tester is *niet* verantwoordelijk voor het achteraf controleren van het werk van de ontwikkelaar](/blog/25/12/hoe-testers-kwaliteit-kunnen-ondermijnen/ "'Hoe testers kwaliteit kunnen ondermijnen'"). Het introduceren van een controlestap neemt de prikkel weg van de ontwikkelaar om te bewijzen dat de software werkt zoals bedoeld en ondermijnt daarmee de kwaliteit. (Dit betekent niet dat er überhaupt geen plek is voor controle, daar kom ik later op terug.)


Het is verleidelijk om nu de taak of taken te noemen waar een tester wél voor verantwoordelijk is, maar door dat te doen zou ik over een belangrijke aanname in de vraag heen stappen. Die wordt duidelijk wanneer we deze parafraseren: *voor welke taak is de tester nog verantwoordelijk, als het niet de taak is de ontwikkelaar te controleren?*
